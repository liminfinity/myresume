...
const experiences: IExperience[] = [
  {
    ...
    achievements: [
      "Спроектировал и разработал основную продуктовую часть интерфейсов сервиса;",
  ...
  },
  {
    ...
    achievements: [
      "Разработал интерфейс в приложении для суммаризации видео с помощью ИИ для всего цикла аутентификации пользователя (авторизация, регистрация, восстановление пароля), а также для загрузки и управления созвонами;",
      "Настроил инфраструктуру проекта (линтер, роутер, husky и др);",
